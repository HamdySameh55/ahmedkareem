/* ================= Shared data ================= */
const PROFILE = {
  nameAr:'حمزه هشام', nameEn:'Hamza Hisham',
  goalAr:'ضخامة', goalEn:'Bulk',
  weightKg:57, heightCm:175, age:19,
  photo:'11bb9469-2785-4720-9bc9-7e0a20236862.jpg', initials:'Hh',
  challengeDays:30,
  challengeStart:'2026-09-05',
};
...
const DAYS = [
  { key:'chest-back', ar:'اليوم ١', en:'Day 1', titleAr:'صدر + ظهر', titleEn:'Chest + Back',
    ex:[
      {id:'bench-press', en:'Bench Press', ar:'بنش بريس', sets:'4×6–10'},
      {id:'incline-dumbbell-press', en:'Incline Dumbbell Press', ar:'انكلين دمبل بريس', sets:'3×8–12'},
      {id:'chest-fly', en:'Incline Cable Fly', ar:'انكلين كيبل فلاي', sets:'3×10–15'},
      {id:'chest-dips', en:'Chest Dips', ar:'تشيست ديبس', sets:'3×8–12'},
      {id:'lat-pulldown', en:'Lat Pulldown', ar:'لات بولداون', sets:'4×8–12'},
      {id:'chest-supported-row', en:'Chest-Supported Row', ar:'تشيست سبورتد رو', sets:'3×8–12'},
      {id:'seated-cable-row', en:'Seated Cable Row', ar:'سيتد كيبل رو', sets:'3×10–12'},
      {id:'straight-arm-pulldown', en:'Straight-Arm Pulldown', ar:'سترايت آرم بولداون', sets:'3×12–15'},
    ]},
  { key:'delts-arms', ar:'اليوم ٢', en:'Day 2', titleAr:'كتف + باي + تراي', titleEn:'Delts + Biceps + Triceps',
    ex:[
      {id:'shoulder-press', en:'Seated Dumbbell Shoulder Press', ar:'سيتد دمبل شولدر بريس', sets:'3×6–10'},
      {id:'dumbbell-lateral-raise', en:'Dumbbell Lateral Raise', ar:'دمبل لاترال رايز', sets:'4×10–15'},
      {id:'cable-lateral-raise', en:'Cable Lateral Raise', ar:'كيبل لاترال رايز', sets:'3×12–15'},
      {id:'reverse-pec-deck', en:'Reverse Pec Deck', ar:'ريفيرس بيك ديك', sets:'3×12–15'},
      {id:'incline-dumbbell-curl', en:'Incline Dumbbell Curl', ar:'انكلين دمبل كيرل', sets:'3×8–12'},
      {id:'ez-bar-curl', en:'EZ-Bar Curl', ar:'اي زي بار كيرل', sets:'3×8–12'},
      {id:'hammer-curl', en:'Hammer Curl', ar:'هامر كيرل', sets:'3×10–15'},
      {id:'triceps-pushdown', en:'Cable Pushdown', ar:'كيبل بوش داون', sets:'3×8–12'},
      {id:'overhead-triceps-extension', en:'Overhead Cable Extension', ar:'اوفرهيد كيبل اكستنشن', sets:'3×10–15'},
    ]},
  { key:'legs', ar:'اليوم ٣', en:'Day 3', titleAr:'رجل', titleEn:'Legs',
    ex:[
      {id:'squat', en:'Squat', ar:'سكوات', sets:'4×6–10'},
      {id:'leg-press', en:'Leg Press', ar:'ليج بريس', sets:'3×8–12'},
      {id:'leg-extension', en:'Leg Extension', ar:'ليج اكستنشن', sets:'3×12–15'},
      {id:'romanian-deadlift', en:'Romanian Deadlift', ar:'رومانيان ديدليفت', sets:'3×8–12'},
      {id:'leg-curl', en:'Leg Curl', ar:'ليج كيرل', sets:'3×10–15'},
      {id:'standing-calf-raise', en:'Standing Calf Raise', ar:'ستاندينج كاف رايز', sets:'4×10–15'},
      {id:'seated-calf-raise', en:'Seated Calf Raise', ar:'سيتد كاف رايز', sets:'3×12–20'},
    ]},
  { key:'chest-back-2', ar:'اليوم ٤', en:'Day 4', titleAr:'صدر + ظهر', titleEn:'Chest + Back',
    ex:[
      {id:'incline-barbell-press', en:'Incline Barbell Press', ar:'انكلين باربل بريس', sets:'4×6–10'},
      {id:'machine-chest-press', en:'Machine Chest Press', ar:'ماكينة تشيست بريس', sets:'3×8–12'},
      {id:'cable-fly', en:'Cable Fly', ar:'كيبل فلاي', sets:'3×12–15'},
      {id:'pull-up', en:'Pull-Ups', ar:'بول ابس', sets:'4×6–10'},
      {id:'t-bar-row', en:'T-Bar Row', ar:'تي بار رو', sets:'3×8–12'},
      {id:'one-arm-cable-row', en:'One-Arm Cable Row', ar:'وان آرم كيبل رو', sets:'3×10–12'},
      {id:'pullover-machine', en:'Pullover Machine', ar:'بول اوفر ماكينة', sets:'3×10–15'},
    ]},
  { key:'delts-arms-2', ar:'اليوم ٥', en:'Day 5', titleAr:'كتف + باي + تراي', titleEn:'Delts + Biceps + Triceps',
    ex:[
      {id:'machine-shoulder-press', en:'Machine Shoulder Press', ar:'ماكينة شولدر بريس', sets:'3×8–12'},
      {id:'cable-lateral-raise', en:'Cable Lateral Raise', ar:'كيبل لاترال رايز', sets:'4×10–15'},
      {id:'dumbbell-lateral-raise', en:'Dumbbell Lateral Raise', ar:'دمبل لاترال رايز', sets:'3×12–15'},
      {id:'rear-delt-fly', en:'Rear Delt Fly', ar:'ريير دلت فلاي', sets:'3×12–15'},
      {id:'preacher-curl', en:'Preacher Curl', ar:'بريتشر كيرل', sets:'3×8–12'},
      {id:'cable-curl', en:'Cable Curl', ar:'كيبل كيرل', sets:'3×10–15'},
      {id:'hammer-curl', en:'Hammer Curl', ar:'هامر كيرل', sets:'2–3×10–15'},
      {id:'close-grip-bench', en:'Close-Grip Bench Press', ar:'كلوز جريب بنش بريس', sets:'3×6–10'},
      {id:'overhead-triceps-extension', en:'Overhead Cable Extension', ar:'اوفرهيد كيبل اكستنشن', sets:'3×10–15'},
      {id:'rope-pushdown', en:'Rope Pushdown', ar:'روپ بوش داون', sets:'2–3×12–15'},
    ]},
  { key:'legs-2', ar:'اليوم ٦', en:'Day 6', titleAr:'رجل', titleEn:'Legs',
    ex:[
      {id:'hack-squat', en:'Hack Squat', ar:'هاك سكوات', sets:'4×6–10'},
      {id:'bulgarian-split-squat', en:'Bulgarian Split Squat', ar:'بلغاري سبليت سكوات', sets:'3×8–12'},
      {id:'leg-extension', en:'Leg Extension', ar:'ليج اكستنشن', sets:'3×12–15'},
      {id:'romanian-deadlift', en:'Romanian Deadlift', ar:'رومانيان ديدليفت', sets:'3×8–12'},
      {id:'seated-leg-curl', en:'Seated Leg Curl', ar:'سيتد ليج كيرل', sets:'3×10–15'},
      {id:'standing-calf-raise', en:'Standing Calf Raise', ar:'ستاندينج كاف رايز', sets:'4×10–15'},
      {id:'seated-calf-raise', en:'Seated Calf Raise', ar:'سيتد كاف رايز', sets:'3×12–20'},
    ]},
];
    ...
    <div class="row">
      <div class="identity">
        <div class="avatar">
          ...
          <img src="11bb9469-2785-4720-9bc9-7e0a20236862.jpg" alt="Hamza Hisham" onerror="this.remove()">
        </div>
        <div class="greet">
          <span class="hello i18n-ar">أهلاً بيك تاني</span><span class="hello i18n-en">Welcome back</span>
          <span class="name i18n-ar">حمزه هشام</span><span class="name i18n-en">Hamza Hisham</span>
        </div>
      </div>
